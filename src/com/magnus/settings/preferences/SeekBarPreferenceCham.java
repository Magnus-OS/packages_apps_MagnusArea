package com.magnus.settings.preferences;
...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String magnusSETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, magnusSETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, magnusSETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(magnusSETTINGSNS, "interval");
            if(newInterval != null)
